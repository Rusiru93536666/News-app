...
import com.example.news5.HomeReporter
...
private lateinit var adapter: MyAdapterReporter
...
override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val gridLayoutManager = GridLayoutManager(this@HomeAdmin,1)
    binding.recyclerView.layoutManager = gridLayoutManager
    val builder = AlertDialog.Builder(this@HomeAdmin)
    val dialog = builder.create()

    dataList = ArrayList()
    adapter = MyAdapterReporter(this@HomeAdmin, dataList)
...
fun searchList(text: String) {
    ...
    adapter.searchDataListReporter(searchList)
}
}