...
import com.example.news5.databinding.ActivitySigninReporterBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.auth.ktx.auth
import com.google.firebase.ktx.Firebase

class SigninReporter : AppCompatActivity() {
    private lateinit var auth : FirebaseAuth
    private lateinit var binding : ActivitySigninReporterBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySigninReporterBinding.inflate(layoutInflater)
        ...
        binding.signinbtn.setOnClickListener{
            ...
            if(chechAllField()){
                auth.signInWithEmailAndPassword(email, password).addOnCompleteListener{
                    if (it.isSuccessful){
//                            successfully signin
                        val intent = Intent(this, HomeReporter::class.java)
